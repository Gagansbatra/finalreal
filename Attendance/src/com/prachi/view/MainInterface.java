		 ...
		 try{
			 out.println("<html lang='en'>");
		      ...
		      //  out.println("          <h2>Login or Create an Account</h2>");
		        ...
		        //out.println("<img src='home2/images/img.png' class='img-responsive'>");
		        out.println("<img src='home2/images/img1.png' class='img-responsive'>");
		       // out.println("<img src='home2/images/students.png' class='img-responsive'>");

		        out.println("            </div>");
		        out.println("          </div>");
		        out.println("<div>");
		        out.println("Online Student Attendance and Marks Management System is a software developed for daily student attendance in schools, collages and institutes. If facilitates to access the attendance information of a particular student in a particular class. <br><br> Purpose:- The purpose of developing attendance management system is to computerized the tradition way of taking attendance. Another purpose for developing this software is to generate the report automatically at the end of the session or in the between of the session <br><br>Scope:- The scope of the project is the system on which the software is installed, i.e. the project is developed as a desktop application, and it will work for a particular institute. But later on the project can be modified to operate it online. ");
		        out.println("    </div>");
		   ...
		   /*    out.println("          <div class='col-2 registered-users'><strong>Student Login</strong>");
		        ...
		        out.println("                  <input type='text' name= class='input-text required-entry'>");
		        out.println("                </li>");
		        out.println("                <li>");
		        out.println("                  <label for='#'>Password <span class='required'>*</span></label>");
		        out.println("                  <input type='password' name= class='input-text required-entry validate-password'>");
		        out.println("                </li>");
		        out.println("              </ul>");
