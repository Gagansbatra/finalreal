...
/**
 * Servlet implementation class FetchAllFacultyJSON
 */
@WebServlet("/FetchAllFacultyJSON")
public class FetchAllFacultyJSON extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public FetchAllFacultyJSON() {
        super();
