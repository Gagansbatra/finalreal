...
public class AdminLogin extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		// TODO Auto-generated method stub
           ...
           out.println("<form action=AdminCheckPwd method=post");
           out.println("            <div class='content'>");
           out.println("              <ul class='form-list'>");
           out.println("                <li>");
           out.println("                  <label for='#'>Admin ID <span class='required'>*</span></label>");
           out.println("                  <input type='text' name=aid class='input-text required-entry'>");
           out.println("                </li>");
           out.println("                <li>");
           out.println("                  <label for='#'>Password <span class='required'>*</span></label>");
           out.println("                  <input type='password' name=pwd class='input-text required-entry validate-password'>");
           out.println("                </li>");
           out.println("              </ul>");
