...
/**
 * Servlet implementation class FetchStudents
 */
...
public class FetchStudents extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		try{
			ResultSet rs=AttendanceDAO.FetchStudents(request.getParameter("bid"),request.getParameter("sm"),request.getParameter("sbid"));
