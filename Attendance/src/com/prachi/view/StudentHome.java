...
public class StudentHome extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		PrintWriter out=response.getWriter();
		 ...
		 out.println(" <div ><h6><font color=green>Student Id:"+ses.getValue("SID").toString()+"["+ses.getValue("SN").toString()+"]</font>&nbsp;"+ses.getValue("LDATE").toString()+"&nbsp;&nbsp;<a href=StudentLogout>LogOut</a>&nbsp;<img src=pic/"+ses.getValue("SPIC").toString()+" width=28 height=28></h6></div>");
		 out.println("            <div>");
		 out.println("            </div>");
		 out.println("          </div>");
		 out.println("          <!-- Top Cart -->");
		 ...
		 out.println(" <iframe frameborder=0 width=800 height=800 name=mw></iframe>");
		 out.println("            </div>");
		 out.println("          </article>");
		 out.println("        </div>");
		 ...
		 out.println("                <ul>");
		 out.println("                  <li> <a class='active' href=ViewAttendance target=mw>View Attendance</a> <span class='subDropdown minus'></span></li>");
		 out.println("                  <li> <a href=ViewMarks target=mw>View Marks</a> <span class='subDropdown minus'></span></li>");
		// out.println("                  <li> <a href=# >Search</a> <span class='subDropdown minus'></span></li>");
		 out.println("                  <li> <a href='StudentLogout'>Logout</a> </li>");
		 out.println("                </ul>");
		 out.println("              </div>");
		 out.println("            </div>");
		 out.println("          </aside>");
